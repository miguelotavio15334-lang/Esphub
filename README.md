-- MIIIGUEX V19 FINAL LIMPO - SEM TATU - TUDO ON + CAPA FIX
...
local bClose=btn("FECHAR [M] - FANTASMA",386,Color3.fromRGB(80,40,40))
...
game.StarterGui:SetCore("SendNotification",{Title="MIIIGUEX V19 FINAL", Text="TUDO ON + CAPA FIX + FANTASMA", Duration=5})
